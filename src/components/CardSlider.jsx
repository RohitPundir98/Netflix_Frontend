...
export default React.memo(function CardSlider({ data, title }) {
  const listRef = useRef(); // Reference for the list container
  const [sliderPosition, setSliderPosition] = useState(0); // State for slider position
  const [showControls, setShowControls] = useState(false); // State for showing slider controls
